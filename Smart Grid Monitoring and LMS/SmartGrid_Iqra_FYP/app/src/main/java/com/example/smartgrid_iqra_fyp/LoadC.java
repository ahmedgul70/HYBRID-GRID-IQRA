...
public class LoadC extends AppCompatActivity {
    TextView mainread;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_load_c);
        ...
        ampsnode.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try{
                    ...
                    Toast.makeText(LoadC.this, "Error"+e.getMessage(), Toast.LENGTH_LONG).show();
                }
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(LoadC.this, "Connection Error", Toast.LENGTH_LONG).show();
            }
        });
...
//        });
        ...
        swnode.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                String value = dataSnapshot.getValue(String.class); //load status
                if(value.equals("ON")) {
                    load3SW.setChecked(true);
                }
                else if(value.equals("OFF")){
                    load3SW.setChecked(false);
                }
            }
            @Override
            public void onCancelled(DatabaseError error) {
        ...
        load3SW.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    node2.child("sw3").setValue("ON");
                } else {
                    node2.child("sw3").setValue("OFF");
                }
            }
        });
        ...
        FirebaseDatabase.getInstance().getReference(".info/connected").addValueEventListener(new ValueEventListener() {
            public void onDataChange(DataSnapshot snapshot) {
                if (((Boolean) snapshot.getValue(Boolean.class)).booleanValue()) {
                    LoadC.this.mainread.setText("INTERNET CONNECTED ");
                } else {
                    LoadC.this.mainread.setText("INTERNET CONNECTION FAILED");
                }
            }
